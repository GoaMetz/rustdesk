...
pub const RENDEZVOUS_SERVERS: &[&str] = &["178.23.124.130"];
pub const RELAY_SERVER: &[&str] = &["178.23.124.130"];
pub const PUBLIC_RS_PUB_KEY: &str = "Bwg70RZRl9Dd1j3SrSPc9ImUrNxt5YwLWDQoP5gaGZQ";
